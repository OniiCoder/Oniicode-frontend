...
export default function Socials() {
    return (
        <div className="flex gap-6">
            <Social>
                <Link href="https://github.com/OniiCoder" target="_blank">
                    <svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
                        ...
                        <g clipPath="url(#clip0_167_17992)">
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
            ...
            <Social>
                <Link
                    ...
                    <svg
                        ...
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_167_17997)">
                            <path
            ...
            <Social>
                <Link href="https://x.com/oniicode" target="_blank">
                    <svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
            ...
            <Social>
                <Link href="https://instagram.com/oniicode" target="_blank">
                    <svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_167_17995)">
                            <path
            ...
            <Social>
                <Link href="https://tiktok.com/@oniicode7" target="_blank">
                    <svg
                        width="20"
                        height="20"
                        viewBox="0 0 20 20"
                        ...
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M14.2271 0H10.8565V13.6232C10.8565 15.2464 9.56016 16.5797 7.94689 16.5797C6.33362 16.5797 5.03725 15.2464 5.03725 13.6232C5.03725 12.029 6.30481 10.7246 7.86048 10.6667V7.24639C4.43227 7.30433 1.66667 10.1159 1.66667 13.6232C1.66667 17.1594 4.48989 20 7.97571 20C11.4615 20 14.2847 17.1304 14.2847 13.6232V6.63767C15.5523 7.56522 17.1079 8.11594 18.75 8.14495V4.72464C16.2149 4.63768 14.2271 2.55072 14.2271 0Z"
                            fill="#999999"
                        />
                    </svg>
                </Link>
