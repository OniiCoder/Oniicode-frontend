                ...
                <div className="fixed top-0 left-0 w-full border-b-[1px] border-b-[#F5F5F5] z-50">
                    <div className="bg-white">
                        <div className="max-w-[1216px] mx-auto lg:flex items-center max-w-[1440px] mx-auto py-5 lg:py-5 px-4">
                                ...
                                <div className="flex lg:hidden">
                                    <button
                                        ...
                                        <svg
                                            ...
                                            />
                                            <path
                                                d="M17.4316 6.75L6.75029 17.2813"
                                                stroke="#292929"
                                                strokeWidth="1.5"
                                                strokeLinecap="round"
                                                strokeLinejoin="round"
                            ...
                            {/* web */}
                            <div
                                className={`hidden flex-grow lg:flex flex-col lg:flex-row gap-6 justify-between items-center`}>
                                <NavigationLinks />
                            ...
                            {/* mobile */}
                            <div
                                className={`${!menuOpen ? 'hidden' : ''} flex-grow flex flex-col lg:flex-row gap-6 justify-between items-center`}>
                                <NavigationLinks />
                                <div className="flex flex-col md:flex-row gap-6 items-center lg:justify-center">
                                    <Socials />
                                    <PrimaryButton
